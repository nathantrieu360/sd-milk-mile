    ...
    <>
      ...
      <div className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-stats">
            {[["2nd","Annual Event"],["June 23","Race Day 2026"],["$600","Charity Goal (RMHC)"],["4×","Milk Per Racer"]].map(([n,l]) => (
      ...
      <section className="event-section" id="event">
        <div className="section-inner">
          ...
          <div className="event-grid fade-up">
            {[["📅","Date","June 23, 2026","Monday Evening"],["🕖","Start Time","6:45 PM","Warm-ups at 6:30"],["📍","Venue","Rancho Bernardo HS","13010 Paseo Lucido, SD"],["🎫","Bib Pickup","June 20–22","Del Norte HS Student Lot"]].map(([icon,label,value,sub]) => (
      ...
      <section className="gallery-section" id="gallery">
        ...
        <div className="gallery-grid fade-up" style={{maxWidth:"1200px",margin:"0 auto"}}>
          {[[img6,"Group Run"],[img1,"Pre-Race"],[img2,"Speed Work"],[img3,"Medal Ceremony"]].map(([src,tag],i) => (
